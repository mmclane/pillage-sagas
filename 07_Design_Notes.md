...
- **Wise Woman Healer Skill** reworded — removed the "free first cast" terminology (Pillage doesn't have casting). Now: "first heal attempt each game does not consume the Healer's action."
