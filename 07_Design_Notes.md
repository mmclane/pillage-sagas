...
- **Twist deck expanded to 25.** Added 9 new Twists in v0.3: First Light (extends game by 2 turns), Foreign Mercenary (d6 4+ for free figure at turn 3), Burning Field (a field starts on fire), Treacherous Footing (charges roll d6, 1 = trip and fail), Sacred Stone (impassable center stone, +1 morale in contact), Open Pit (2 pit markers, fall in on 1, Down 1 turn), No Cavalry (neither side fields cavalry), Bowmen in Cover (3 free stationary archers for defender), A Wandering Skald (neutral NPC scatters d6 per turn; kill = -2 Renown, escort off your edge = +2 Renown). New Narrative category added. Final categories: Weather (4), Timing/Reinforcements (6), Terrain (9), Force/Composition (4), Narrative (1), Composition (1).
